...
import styless from "../styles/pages/LandingPage.module.css";
    ...
    <>
      ...
      <div className={styless.header}>
        <div className="pu_container" ref={headerContainer}>
          <div className={styless.header_inner}>
            <div className={styless.logo}>
              <Link href="/">
                <a>{svg.logo}</a>
              </Link>
            </div>
            <div className={styless.nav_toggle} onClick={() => navToggle()}>
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
            ...
            <div className={styless.nav} ref={headerNav}>
              <ul>
                <li>
            ...
            <div className={styless.header_action}>
              {isUserLogin ? (
                <Link href="/dashboard">
                ...
                <>
                  <Link href="/auth/login">
                    <a className={"pu_btn pu_btn_link " + styless.pu_btn_link}>
                      Sign In
                    </a>
                  </Link>
            ...
            <div
              className={"pu_dropdown_wrapper " + styless.header_action_mobile}
            >
              <div
                className={"pu_dropdown_toggle " + styless.header_action_avatar}
              ...
              <div className={"pu_dropdown_dd " + styless.profile_dropdown}>
                <ul>
                  <li>
                    <Link href="/auth/login">
      ...
      <div className={styles.contact_section}>
        <div className={styles.contactus_main_heading}>
          <video className={styles.background_video} autoPlay loop muted>
            <source src="/images/dashboard/awardbgvideo.mp4" type="video/mp4" />
            Your browser does not support the video tag.
          </video>
          <div className={styles.overlay_content}>
            <h1>
              ContactUs <span className={styles.dash_underline}></span>
            </h1>
            <h6>
              <Link href="/index">
                <a>Home --</a>
        ...
        <img
          ...
          src="/images/dashboard/shape.png"
          alt="wave"
        />
        <div className={styles.demo_email}>
          <div className={styles.cintact_info}>
            <h6>
              Contact Info <span className={styles.get_dash_underline}></span>
            </h6>
          ...
          <div className={styles.contact_email}>
            <h4>
              E-Mail Address
              <span className={styles.emil_dash_underline}></span>
            </h4>
            <p>contact@kycmeta.live</p>
          </div>
        </div>
        <div className={styles.container}>
          <div className={styles.img}>
            <img src="/images/dashboard/cont.png" alt="background" />
          </div>
          <div className={styles.contact_content}>
            <form className={styles.contactus_form} onSubmit={handleSubmit}>
              <div className={styles.contact_box}>
                <h2 className={styles.contactus_heading}>
                  Get In Touch
                  <span className={styles.get_dash_underline}></span>
                </h2>
                <div className={styles.fxt_form}>
                  <div className="fxt-column-wrap justify-content-center">
                    ...
                    <button className={styles.fxt_btn_fill} type="submit">
                      Send Message
                    </button>
                  </div>
                </div>

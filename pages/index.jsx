...
import { contactus } from "../src/redux/actions/authAction";
...
const Home = () => {
  ...
  useEffect(() => {
    dispatch(
      setPageHeading({
        title:
          "PixaURL - Connect And Manage All Your Social Links At One Place",
        keywords:
          "pixaurl, pixaurl.com, pixa url, biolink, bio link, miniwebsite, mini website, social link, personal link, portfolio link, bio link generator",
        description:
          "Connect and manage all your social links in one place. Organize your social handles into a single tap. Get a link and work smart.",
        pageHeading:
          "PixaURL - Connect And Manage All Your Social Links At One Place",
      })
    );
  ...
  const [testimonial, setTestimonial] = useState([
    ...
    },
    {
      ...
      title: "UI/UX Designer",
      description:
        "Etiam venenatis ultricies elit, nec posuere leo tempus nec. Cras vitae velit accumsan lectus dictum bibendum. Nunc scelerisque molestie massa, eu pellentesque urna malesuada sit",
    },
    {
      id: 3,
      ...
      title: "UI/UX Designer",
      description:
        "Cras vitae velit accumsan lectus dictum bibendum. Nunc scelerisque molestie massa, eu pellentesque urna malesuada sit amet. Praesent porttitor erat tellus, eu iaculis dolor venenatis ut.",
    },
    {
      id: 4,
      ...
      title: "UI/UX Designer",
      description:
        "Etiam venenatis ultricies elit, nec posuere leo tempus nec. Cras vitae velit accumsan lectus dictum bibendum. Nunc scelerisque molestie massa, eu pellentesque urna malesuada sit amet. ",
    },
    {
      id: 5,
      ...
      title: "UI/UX Designer",
      description:
        " eu iaculis dolor venenatis ut. Nulla ullamcorper mattis egestas. Vestibulum vulputate pulvinar mi vitae placerat.",
    },
    {
      id: 6,
      ...
      title: "UI/UX Designer",
      description:
        "Nunc scelerisque molestie massa, eu pellentesque urna malesuada sit amet. Praesent porttitor erat tellus, eu iaculis dolor venenatis ut. Nulla ullamcorper mattis egestas. Vestibulum vulputate pulvinar mi vitae placerat.",
    },
  ]);
  ...
  return (
    <>
      ...
      <div className={styles.wrapper}>
          ...
          <div className="pu_container" ref={headerContainer}>
            <div className={styles.header_inner}>
              ...
              >
                <div
                  className={
                    "pu_dropdown_toggle " + styles.header_action_avatar
                  }
        ...
        >
          <div
            className={styles.bg_left}
            style={{ backgroundImage: "url('./images/landing/bg_left.png')" }}
          ></div>
          <div className="pu_container banner__full">
            <div className={styles.banner_content}>
              <div className={styles.banner_left}>
                ...
                <p>
                  Connect and manage all your social links in one place.
                  Organize your social handles into a single tap. Get a link and
                  work smart.
                </p>
                <Link href="/auth/login">
                  <a className="pu_btn">Get Started {svg.btn_arrow_right}</a>
                </Link>
              </div>
              <div className={styles.banner_right}>
                <div className={styles.banner_img}>
                  <img
                    className={styles.options_mainimg}
                    src="./images/landing/mobile.png"
                    alt="banner"
                  />
                  <img
                    className={`${styles.bg_options} ${styles.bg_options1}`}
                    src="./images/landing/options.png"
                    alt="banner"
                  />
                </div>
              </div>
            ...
            <div className={styles.core_feature_content}>
              <div className={styles.core_feature_left}>
                <div className={styles.core_feature_box}>
                  ...
                  <p>
                    Experience the vast access to various platforms fosters an
                    enormous engagement.
                  </p>
                  <Link href="/">
                    <a className="">{svg.landing_angle}</a>
                  </Link>
                </div>
                <div className={styles.core_feature_box}>
                  ...
                  <p>
                    Create a single link and save a bunch of hours for you and
                    your subscribers.
                  </p>
                  <Link href="/">
                    <a className="">{svg.landing_angle}</a>
              ...
              <div className={styles.core_feature_right}>
                ...
                <p>
                  PixaURL provides a single location to concentrate your
                  follower’s attention on your every social media account. Also,
                  you can customize your profile with the available creative
                  templates. Here you can edit the content and add the links to
                  your website or social media handles. It helps you keep in
                  touch with your followers/subscribers for longer.
                </p>
                <Link href="/auth/login">
        ...
        <div
          ...
          id="stab_template"
          style={{ backgroundImage: "url('./images/landing/template-bg.jpg')" }}
        >
          <div className="pu_landing_templates">
            <div className={styles.main_heading}>
              <h3>Start With Creative Templates</h3>
              <strong>
                Get started with PixaURL to play around with these stunning
                templates.
              </strong>
            </div>
        ...
        <div className={styles.works} id="stab_howitwork">
          <div className="pu_container">
            <div className={styles.main_heading}>
              <h3>How it Works</h3>
              <strong>
                Get one link to make your followers step into your digital
                province.
              </strong>
            </div>
              ...
              <div className={styles.works_left}>
                <div className={styles.works_box}>
                  ...
                  <div className={styles.works_box_data}>
                    ...
                    <p>
                      Choose a template from the available 10+ designs, we
                      provide.
                    </p>
                  </div>
                </div>
                ...
                <div className={styles.works_box}>
                  ...
                  <div className={styles.works_box_data}>
                    <h3>Copy & Share </h3>
                    <p>
                      Tadda!!!!! You are ready to share the single link with
                      your visitors and get more engagement.{" "}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className={styles.works_video}>
                  <div className={styles.video_container}>
                    <iframe
                      width="560"
                      height="315"
                      src="https://www.youtube.com/embed/P_aBjfsx_Gg"
        ...
        <div
          ...
          style={{
            backgroundImage: "url('./images/landing/banner_bg.jpg')",
            display: "none",
          }}
        >
          <div className="pu_container">
            <div className={styles.main_heading}>
              ...
              <strong>
                Pellentesque sem nunc, consequat non ullamcorper eu
              </strong>
            </div>
            <div
              className={styles.testimonial_main}
              style={{
                backgroundImage: "url('./images/landing/shapesbg.png')",
              }}
            >
              <div className={styles.testimonial_list_main}>
                <ul>
                  {testimonial.map((item) => (
                    <li
                      key={item.id}
                      onClick={() => activeTestimonialHandle(item)}
                      className={item.id === activeTest.id ? styles.active : ""}
                    >
                ...
                <div className={styles.testimonial_box_contant}>
                  <div className={styles.testimonial__box}>
                    <span className={styles.icon_testimonial}>
                      {" "}
                      <img
                        src="./images/landing/Shapetestimonial.png"
                        alt="testimonial"
                      />
                    </span>
                    <p className={styles.content_box_tes}>
        ...
        <div
          className={styles.exclusive_features_wr}
          id="stab_features"
          style={{ backgroundImage: "url('./images/landing/features-bg.jpg')" }}
        >
          <div className="pu_container">
            <div className={styles.main_heading}>
              <h3>Features</h3>
            ...
            <div className={styles.exclusive_features_main}>
              <div className={styles.features_box}>
                <div className={styles.features_box_item}>
                  ...
                  <p>
                    Examine your daily graph of profile visits and weekly
                    clicks.
                  </p>
                </div>
              </div>
              <div className={styles.features_box}>
                <div className={styles.features_box_item}>
                  ...
                  <p>
                    Generate as many links you wish to share with your preferred
                    audience.
                  </p>
                </div>
              </div>
              <div className={styles.features_box}>
                <div className={styles.features_box_item}>
                  ...
                  <p>
                    Share your favorite music, podcasts, videos, and saved pins.
                  </p>
                </div>
              </div>
              <div className={styles.features_box}>
                <div className={styles.features_box_item}>
                  ...
                  <p>
                    Influence and Connect with a large audience in the world
                  </p>
                </div>
              </div>
              <div className={styles.features_box}>
                <div className={styles.features_box_item}>
                  ...
                  <p>
                    Monetize your link by connecting it to other payment apps
                    and smartly earn profits.
                  </p>
                </div>
              </div>
              <div className={styles.features_box}>
                <div className={styles.features_box_item}>
                  ...
                  <p>
                    A single link can take people to your ideas on different
                    pages.
                  </p>
                </div>
              </div>
          ...
          <div className="pu_container">
            <div className={styles.footer_main_box}>
              <div className={`${styles.footer_item} ${styles.footer_list_1}`}>
                <div className={styles.logo_footer}>{svg.logo}</div>
                <p>
                  PixaURL allows you to create a custom, personalized page that
                  stores all the prominent links you wish to share with your
                  viewers.
                </p>
              </div>

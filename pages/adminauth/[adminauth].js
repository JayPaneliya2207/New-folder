...
import { adminLogin } from "../../src/redux/actions/authAction";
...
const Adminauth = (props) => {
  ...
  const onFormSubmit = async (e, submitType) => {
    ...
    if (submitType === "forgot-password") {
      ...
      if (!passlength) {
        AlertMsg(
          "error",
          "Oops!",
          "Password should be between 3 to 15 characters."
        );
        return false;
      }
    }
    ...
    props.adminLogin(submitType, { email, password, name });
    setIsVerify(true);
  };
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Connect and manage all your social links in one place. Organize your social handles into a single tap. Get a link and work smart."
        />
        <meta
          name="keywords"
          content="pixaurl, pixaurl.com, pixa url, biolink, bio link, miniwebsite, mini website, social link, personal link, portfolio link, bio link generator"
        />
      ...
      <div className={styles.auth_bg}>
        <span
          className={styles.auth_bg_circle + " " + styles.auth_bg_circle_1}
        ></span>
        <span
          className={styles.auth_bg_circle + " " + styles.auth_bg_circle_2}
        ></span>
        <span
          className={styles.auth_bg_circle + " " + styles.auth_bg_circle_3}
        ></span>
      </div>
      <div className={styles.auth_wrapper}>
        <div className={styles.auth_header}>
          <h3 className={styles.auth_welcome}>Welcome To Admin</h3>
        </div>
              ...
              {authType == "registration" ? (
                <>
                  {!isVerify ? (
                    <>
                      <h3>
                        Let’s Started with <span>PixaURL.</span>
                      </h3>
                      <p>
                        Connect and manage all your social links at one place
                      </p>
                      ...
                      <div className={styles.auth_input_wrapper}>
                        ...
                        <span
                          className={
                            styles.pu_auth_icon +
                            " " +
                            styles.pu_auth_showhide_password
                          }
                      ...
                      <br />
                      <button type="submit" className="pu_btn pu_btn_big">
                        Create Account
                      </button>
                    ...
                    <>
                      <div className={styles.isverify_wrapper}>
                        ...
                        <br />
                        <p>
                          We send an email with a link to verify your account.
                          If you have not received the email after a few
                          minutes, please check your spam folder.
                        </p>
                        <p>If you already verify your email.</p>
                        <Link href="/auth/login">
                          <a className="pu_btn">Login Now</a>
                        </Link>
                      </div>
                    </>
                  )}
                ...
                <>
                  ...
                  <p>
                    Enter your account email, We will send you instructions{" "}
                    <br />
                  ...
                  <div className={styles.auth_forgotremember}>
                    <div className="pu_checkbox">
                      <input
                        type="checkbox"
                        id="remember_me"
                        checked={isRememberMe === true ? "checked" : ""}
...
const mapDispatchToProps = (dispatch) => {
  return {
    adminLogin: (type, data) => dispatch(adminLogin(type, data)),
  };
};

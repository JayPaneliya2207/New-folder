...
const directIncome = () => {
  ...
  const columns = [
    ...
    { name: "From (Name)", selector: (row) => row.name, sortable: true },
    {
      name: "From (Username)",
    ...
    },
    {
      ...
      selector: (row) => row.activePackage,
      sortable: true,
    },
    { name: "Amount (₹)", selector: (row) => row.amount, sortable: true },
    {
      name: "Self (MAX) Package (₹)",
